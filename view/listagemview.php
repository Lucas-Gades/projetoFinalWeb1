    ...
    class ListagemView {
        ...
        public static function criarCard($jogadores) {
            foreach($jogadores as $jogador) {
                ...
                echo "
                <div>
                    <aside class='col-md-3 col-sm-6 col-lg-2 col-12'>
                        <div class='card  ml-2 p-0 mt-5' style='width: 16rem; background: yellow; border: 5px solid darkgreen; margin-bottom:20px;'>
